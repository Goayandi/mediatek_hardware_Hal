...
#define P2P_GO_NEG_CNF_MAX_RETRY_COUNT 10
#else
...
#ifdef CONFIG_MTK_P2P
#define P2P_DEV_SD_INFO BIT(20)
#define P2P_DEV_SD_SCHEDULE BIT(21)
#define P2P_DEV_INVITE_SCHEDULE BIT(22)
#endif
	unsigned int flags;
...
// Peter: add for Beamplus application
	/* P2P Beam Plus Scan is used or not */
	int in_beam_scan;
	
	/* P2P Beam Plus GO reserve. Reserve channel and skip legacy wlan scan */
	int in_beam_go_reserve;
